      ...
      <div className="container">
        ...
        <div className="w-full">
          <p>
            ...
            <b className="text-2xl">• 1. Quais dados coletamos sobre você e para qual finalidade?</b> <br /><br />
            Para melhorar sua experiência em nossos canais e para que possamos lhe oferecer nossos serviços e realizar o cumprimento das legislações, coletamos: <br /><br />
            ...
            <br />
            - Dados Cadastrais: nome completo, e-mail, data de nascimento, gênero, telefone, país, cidade, estado.
            <br />
            - Dados profissionais: experiência profissional, empresa e cargo ocupado, escolaridade e idiomas.
            <br /><br />
            ...
            - Cookies: são pequenos arquivos de texto armazenados em seu navegador ou dispositivo. Os cookies nos permitem reconhecer as suas preferências para adaptar o nosso website às suas necessidades específicas. <br />
            - Web beacons: são pequenos arquivos de imagem incorporados de forma invisível na página web e servem para coletar determinadas informações de seu computador, ou dispositivo móvel nos ajudando a gerenciar melhor o conteúdo disponível em nosso site.<br />
            ...
            Apenas pessoas autorizadas têm acesso a seus dados pessoais<br /><br />

            O acesso a seus dados pessoais é feito somente após o compromisso de confidencialidade<br /><br />
            ...
            - Cookies de funcionalidade, servem para gravar os dados anteriormente fornecidos, como por exemplo as suas informações de login, a fim de melhorar a experiência de navegação; e<br />
            - Cookies de marketing, para que possamos disponibilizar as melhoras ofertas de Produtos e Serviços ao usuário, de acordo com seus interesses. <br /><br />

            Você pode, a qualquer tempo e sem nenhum custo, alterar as permissões, bloquear ou recusar os Cookies. Todavia, a revogação do consentimento de determinados Cookies pode inviabilizar o funcionamento correto de alguns recursos da plataforma.<br /><br />


            Para gerenciar os cookies do seu navegador, basta fazê-lo diretamente nas configurações do navegador, na área de gestão de Cookies. Você pode acessar tutoriais sobre o tema diretamente nos links abaixo:<br /><br />

            Se você usa o Internet Explorer.<br /><br />

            Se você usa o Firefox.<br /><br />

            Se você usa o Safari.<br /><br />

            Se você usa o Google Chrome.<br /><br />

            Se você usa o Microsoft Edge.<br /><br />

            Se você usa o Opera.<br /><br />

            <b className="text-2xl">• 9. Alteração desta Política de Privacidade</b><br />
            A atual versão da Política de Privacidade foi formulada e atualizada pela última vez em: 05 de julho de 2021.<br /><br />


            Reservamos o direito de modificar essa Política de Privacidade a qualquer tempo, principalmente em função da adequação a eventuais alterações feitas em nosso site ou em âmbito legislativo. Recomendamos que você a revise com frequência.<br /><br />


            Eventuais alterações entrarão em vigor a partir de sua publicação em nosso site e sempre lhe notificaremos acerca das mudanças ocorridas.<br /><br />
